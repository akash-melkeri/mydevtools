...
<div class="tw-ml-3 tw-max-w-xs tw-rounded-lg tw-overflow-hidden tw-border tw-border-gray tw-mr-16">
  ...
  <div class="tw-flex tw-justify-between">
    <div class="tw-font-bold tw-text-xl tw-mb-2 tw-flex tw-items-center"><div>Hypotenuse ai</div>
...
<div class="tw-ml-3 tw-max-w-xs tw-rounded-lg tw-overflow-hidden tw-border tw-border-gray">
  <img class="tw-w-full hover:tw-scale-110 tw-transition tw-ease-in-out cursor-pointer" :src="post.imageUrl" style="height:160px;" alt="Sunset in the mountains">
  <div class="tw-px-6 tw-py-4">
  <div class="tw-flex tw-justify-between">
    <div class="tw-font-bold tw-text-xl tw-mb-2 tw-flex tw-items-center"><div>Mutiny</div>
    <q-icon name="verified" class="tw-ml-2 tw-text-sky-400"></q-icon>
    </div>
    <div class="tw-flex tw-justify-center tw-items-center">
    <q-icon size="xs" color="grey" name="favorite"></q-icon>
    ...
    <p class="tw-text-gray-700 tw-text-base">
      Mutiny is a no-code AI platform that helps marketers convert their top of funnel demand into revenue, without...
    </p>
  </div>
<div class="tw-px-6 tw-pt-4 ">
<q-chip outline color="primary">
...
<div class="tw-ml-3 tw-max-w-xs tw-rounded-lg tw-overflow-hidden tw-border tw-border-gray tw-ml-16">
  <img class="tw-w-full hover:tw-scale-110 tw-transition tw-ease-in-out cursor-pointer" :src="post.imageUrl" style="height:160px;" alt="Sunset in the mountains">
  <div class="tw-px-6 tw-py-4">
  <div class="tw-flex tw-justify-between">
    <div class="tw-font-bold tw-text-xl tw-mb-2 tw-flex tw-items-center"><div>Simplified</div>
    <q-icon name="verified" class="tw-ml-2 tw-text-sky-400"></q-icon>
    </div>
    <div class="tw-flex tw-justify-center tw-items-center">
    <q-icon size="xs" color="grey" name="favorite"></q-icon>
    ...
    <p class="tw-text-gray-700 tw-text-base">
      Simplified AI Writer is a free ai copywriting assistant that generates high-quality content for blogs,...
    </p>
  </div>
<div class="tw-px-6 tw-pt-4 ">
<q-chip outline color="primary">
<q-icon name="monetization_on"></q-icon><span class="tw-ml-1">Paid</span>
</q-chip>
</div>
  <div class="tw-px-6 tw-pt-4 tw-pb-2">
    <span class="tw-inline-block tw-bg-gray-200 tw-rounded-full tw-px-3 tw-py-1 tw-text-sm tw-font-semibold tw-text-gray-700 tw-mr-2 tw-mb-2">provisioning</span>
...
export default defineComponent({
  ...
  created(){
    ...
    if(Object.keys(this.$route.params).length < 1){
      this.$router.push("/discover/mydevtools");
    }
  }
})
</script>